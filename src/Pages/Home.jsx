import React, { useState, useEffect, useCallback, memo, lazy } from "react";
import {
  Github,
  Linkedin,
  Mail,
    ...
    <div className="relative group">
      ...
      <div className="relative px-3 sm:px-4 py-2 rounded-full bg-black/40 backdrop-blur-xl border border-white/10">
        <span className="bg-gradient-to-r from-gray-500 to-gray-300 text-transparent bg-clip-text sm:text-sm text-[0.7rem] font-medium flex items-center">
          <Sparkles className="sm:w-4 sm:h-4 w-3 h-3 mr-2 text-gray-400" />
          Ready to Innovate
        </span>
      </div>
    </div>
  ...
  <div className="space-y-2 ml-3" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white">
      ...
      <span className="relative inline-block mt-2">
        <span className="absolute -inset-2 bg-gradient-to-r from-gray-500 to-gray-300 blur-2xl opacity-20"></span>
        <span className="relative bg-gradient-to-r from-gray-500 to-gray-300 bg-clip-text text-transparent">
          Developer
        </span>
      </span>
    </h1>
...
const CTAButton = memo(({ href, text, icon: Icon }) => (
  <a href={href}>
    <button className="group relative w-[160px]">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-gray-500 to-gray-300 rounded-xl opacity-50 blur-md group-hover:opacity-90 transition-all duration-700"></div>
      <div className="relative h-11 bg-[#030014] backdrop-blur-xl rounded-lg border border-white/10 leading-none overflow-hidden">
        <div className="absolute inset-0 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500 bg-gradient-to-r from-gray-500/20 to-gray-300/20"></div>
...
const SocialLink = memo(({ icon: Icon, link }) => (
  <a href={link} target="_blank" rel="noopener noreferrer">
    <button className="group relative p-3">
      <div className="absolute inset-0 bg-gradient-to-r from-gray-500 to-gray-300 rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-300"></div>
...
const SOCIAL_LINKS = [
  ...
  { icon: Linkedin, link: "https://www.linkedin.com/in/sainath-bingi/" },
  { icon: Instagram, link: "https://www.instagram.com/bingisainath/" },
];
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                >
                  ...
                  <span className="w-[3px] h-6 bg-gradient-to-t from-gray-500 to-gray-300 ml-1 animate-blink"></span>
                </div>
