...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/sainath-bingi/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@bingisainath",
    icon: Instagram,
    url: "https://www.instagram.com/bingisainath/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@bingisainath5731",
    icon: Youtube,
    url: "https://www.youtube.com/@ReactNativeStuff",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@bingisainath",
    icon: Github,
    url: "https://github.com/bingisainath",
    color: "#ffffff",
